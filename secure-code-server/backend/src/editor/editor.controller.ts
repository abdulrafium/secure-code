import { Controller, Post, Body, BadRequestException, Get, Query, Req, UseGuards, Delete } from '@nestjs/common';
...
export class EditorController {
  ...
  async getTree(
    ...
    return this.editorService.getTree(dirPath || '', projectId, recursive === 'true');
  }
